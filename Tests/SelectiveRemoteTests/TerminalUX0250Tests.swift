...
struct TerminalUX0250Tests {
    ...
    func terminalTransparencyUsesTransparentWebViewAndPaneBackgrounds() throws {
        ...
        #expect(appearance.contains("language.localized(\"appearance.transparent_terminal\")"))
        #expect(AppCopy.translations["appearance.transparent_terminal"]?.en == "Transparent Terminal Background")
    ...
    func paneAppearanceUsesFullEditor() throws {
        ...
        #expect(appearance.contains("DisclosureGroup(language.localized(\"appearance.font_cursor\"))"))
        #expect(appearance.contains("DisclosureGroup(language.localized(\"appearance.syntax\"))"))
        #expect(appearance.contains("DisclosureGroup(language.localized(\"appearance.custom_theme\"))"))
        #expect(appearance.contains("language.localized(\"appearance.copy_general\")"))
