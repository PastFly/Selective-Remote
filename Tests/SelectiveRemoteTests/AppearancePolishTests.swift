...
func managementWorkspaceCompositionContract() throws {
    ...
    #expect(content.contains("ProfileCollectionDisplayModePicker(selection: $teamHostDisplayMode)"))
    #expect(content.contains("@AppStorage(\"SelectiveRemote.team-host.display-mode.v1\")"))
