# Возможности и быстрый старт Selective Remote

[Главная](../README.md) · [English](FEATURES-EN.md)

Подробный справочник по локальным возможностям приложения. Функции Cloud и Vault, запланированные для 0.32, описаны отдельно в [архитектуре Cloud](cloud-v0.32-architecture.md).
