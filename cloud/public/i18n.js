(() => {
  ...
  const en = new Map(Object.entries({
    ...
    "Содержимое": "Content",
    "Копировать": "Copy",
    "⌘C копирует значение выбранного ресурса": "⌘C copies the selected resource value",
    "Закрыть карточку ресурса": "Close resource details",
    "Редактировать запись": "Edit record",
    "Значение скопировано локально. Cloud plaintext не получал.": "Value copied locally. Cloud never received plaintext.",
    "Роль определяет доступ к зашифрованным ресурсам.": "Your role controls access to encrypted resources.",
    "Удалить": "Delete",
    "Создать": "Create",
