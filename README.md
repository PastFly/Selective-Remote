...
![Реальный экран настройки RDP на двух дисплеях в Selective Remote 0.32 candidate с демонстрационными хостами .example](docs/images/demo-032-ru-rdp-displays.webp)
