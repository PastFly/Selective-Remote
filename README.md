...
| Подключайтесь | Организуйте | Работайте |
| --- | --- | --- |
| SSH и RDP, включая несколько мониторов; Telnet и Serial для нужных сценариев. | Профили, группы, избранное и теги держат инфраструктуру в порядке. | Терминал, двухпанельный SFTP, SSH-туннели и Snippets доступны из одного приложения. |
